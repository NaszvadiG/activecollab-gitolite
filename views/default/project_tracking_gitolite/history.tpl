...
{object object=$project_object_repository user=$logged_user}
  ...
  {else}
    <p class="empty_page"><span class="inner">{lang update_url=$project_object_repository->getUpdateUrl()}There are no commits in the database.<br />Would you like to <a href=":update_url" class="repository_ajax_update" title="Update">update</a> this repository{/lang}?</span></p>
  {/if}
  </div>
{/object}
